...
public class RecyclerAdapterBlod extends RecyclerView.Adapter<RecyclerAdapterBlod.ViewHolder> {
    ...
    public RecyclerAdapterBlod(Context context, String[] images, String[] titles, String[] details, String[] url) {
