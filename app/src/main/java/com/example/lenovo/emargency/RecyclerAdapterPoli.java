...
public class RecyclerAdapterPoli extends RecyclerView.Adapter<RecyclerAdapterPoli.ViewHolder> {
    ...
    public RecyclerAdapterPoli(Context context, String[] images, String[] titles, String[] details, String[] url) {
