...
public class RecyclerAdapterAmbu extends RecyclerView.Adapter<RecyclerAdapterAmbu.ViewHolder> {
    ...
    public RecyclerAdapterAmbu(Context context, String[] images, String[] titles, String[] details, String[] url) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(final View itemView) {
           ...
           itemUrl= (ImageButton) itemView.findViewById(R.id.menu2);
