...
public class RecyclerAdapterFire extends RecyclerView.Adapter<RecyclerAdapterFire.ViewHolder> {
    ...
    public RecyclerAdapterFire(Context context, String[] images, String[] titles, String[] details, String[] url) {
